...
<body>
	...
	<script type="text/javascript">
		$.get("read.php",{"paixu":1},function(data){
			...
			for( var i = 0 ; i < data.jieguo.length ; i++){
				...
				$("#biaoge").append($(
					...
					"<tr num=" + o.id + ">" + 
						...
						"<td><a href='code.php?code_id="+o.code+"'>"+o.code+"</a></td>" +
						"<td>" + o.username + "</td>" +
						"<td>" + o.time + "</td>" +
						"<td>" + o.name + "</td>" +
						"<td><a href='touch.php?touch_id="+o.touch_id+"'>联系方式</a></td>" +



						"<td><a href='touch.php?touch_id="+o.touch_id+"'>"+o.confirm+"</a></td>" +
						...
						"<td><a class='xiugai' href='edit1.php?code="+o.code+"&status_id="+o.status_id+"' >修改</a></td>" +
						"<td><a class='del' href='delete.php?code="+o.code+"' >删除</a></td>" +
					"</tr>"
			...
			// 	var $this = $(this);
			// 	//单击事件
			// 	$.get("delete.php",{"code" : } , function(data){
			// 		alert("删除成功！");
